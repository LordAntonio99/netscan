  ...
  return (
    <div className="flex">
      <div className="flex flex-col items-center">
        ...
        {!isLast && (
          <div className="h-full w-0.5 bg-gradient-to-b from-orange-500 to-gray-700 my-2"></div>
        )}
      </div>
      <div className="ml-6">
        <div className="flex items-center mb-2">
          <div className="mr-3 p-2 bg-gray-800 rounded-lg text-orange-500">
            {icon}
          </div>
      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-16">
          <h2 className="text-3xl md:text-4xl font-bold text-white mb-4">
            How <span className="text-orange-500">NetScan</span> Works
          </h2>
        ...
        <div className="mt-16 max-w-2xl mx-auto bg-gray-900 p-8 rounded-lg border border-gray-700">
